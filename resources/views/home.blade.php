@php
//$crudTotal=DB::table('crud')->count('deleted_at');
$crudTotal=DB::table('crud')->whereNull('deleted_at')->count();
    ...
    <div class="container-fluid">
      ...
      <div class="col-md-6 col-lg-2 col-xlg-3">
        ...
        <div class="box bg-cyan text-center">
          ...
          <p style="color:white">{{ $crudTotal }}</p>
        </div>
        </div>
      </div>
      <!-- Column -->
      ...
      <div class="col-lg-6">
        ...
        <div class="comment-widgets scrollable">
          ...
          <div class="p-2">
            <img src="{{ url('/') }}/backend/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle" />
          </div>
          ...
          <div class="p-2">
            <img src="{{ url('/') }}/backend/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle" />
          </div>
          ...
          <div class="d-flex flex-row comment-row">
          <div class="p-2">
            <img src="{{ url('/') }}/backend/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle" />
          </div>
          <div class="comment-text w-100">
        ...
        <div class="card-body">
          ...
          <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
            ...
            <ul class="list-style-none assignedto">
              <li class="assignee">
              <img class="rounded-circle" width="40" src="{{ url('/') }}/backend/assets/images/users/1.jpg" alt="user"
                data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave" />
              </li>
              <li class="assignee">
              <img class="rounded-circle" width="40" src="{{ url('/') }}/backend/assets/images/users/2.jpg" alt="user"
                data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica" />
              </li>
              <li class="assignee">
              <img class="rounded-circle" width="40" src="{{ url('/') }}/backend/assets/images/users/3.jpg" alt="user"
                data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka" />
              </li>
              <li class="assignee">
              <img class="rounded-circle" width="40" src="{{ url('/') }}/backend/assets/images/users/4.jpg" alt="user"
      ...
      <div class="col-lg-6">
        ...
        <div class="card-body">
          ...
          <ul class="chat-list">
            ...
            <li class="chat-item">
            <div class="chat-img">
              <img src="{{ url('/') }}/backend/assets/images/users/1.jpg" alt="user" />
            </div>
            ...
            <li class="chat-item">
            <div class="chat-img">
              <img src="{{ url('/') }}/backend/assets/images/users/2.jpg" alt="user" />
            </div>
            <div class="chat-content">
            ...
            <li class="chat-item">
            <div class="chat-img">
              <img src="{{ url('/') }}/backend/assets/images/users/3.jpg" alt="user" />
            </div>
            <div class="chat-content">
        ...
        <div class="tab-content tabcontent-border">
          ...
          <div class="p-20">
            ...
            <img src="{{ url('/') }}/backend/assets/images/background/img4.jpg" class="img-fluid" />
          </div>
          </div>
